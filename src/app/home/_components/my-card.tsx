...
export function MyCard({
  ...
  return (
    <Link
      href={`/home/fund-movements?accountId=${encodeURIComponent(cardBalanceAccountId)}`}
      aria-label={`${ownerName}의 카드 전체 자금 이동 내역`}
      className="focus-visible:outline-pink-6 flex flex-col overflow-hidden rounded-[20px] bg-[linear-gradient(160deg,rgba(253,237,244,0.8)_2.77%,rgba(251,117,187,0.8)_100%)] px-8 py-6 focus-visible:outline-2"
    >
